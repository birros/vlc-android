...
import com.github.birros.vlc.gui.helpers.NotificationHelper
import com.github.birros.vlc.gui.video.PopupManager
import com.github.birros.vlc.gui.video.VideoPlayerActivity
import com.github.birros.vlc.media.MediaSessionBrowser
...
import com.github.birros.vlc.widget.VLCAppWidgetProvider
import com.github.birros.vlc.widget.VLCAppWidgetProviderBlack
import com.github.birros.vlc.widget.VLCAppWidgetProviderWhite
    ...
    private fun broadcastMetadata() {
        ...
        launch(Dispatchers.Default) {
            sendBroadcast(Intent("com.android.music.metachanged")
                    ...
                    .putExtra("package", "com.github.birros.vlc"))
        }
    }
