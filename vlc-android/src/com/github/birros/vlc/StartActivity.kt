...
import com.github.birros.vlc.gui.BetaWelcomeActivity
import com.github.birros.vlc.gui.MainActivity
import com.github.birros.vlc.gui.SearchActivity
import com.github.birros.vlc.gui.onboarding.ONBOARDING_DONE_KEY
import com.github.birros.vlc.gui.onboarding.startOnboarding
...
class StartActivity : FragmentActivity(), CoroutineScope by MainScope() {
    ...
    private fun resume() {
        ...
        if (Intent.ACTION_SEARCH == action || "com.google.android.gms.actions.SEARCH_ACTION" == action) {
            startActivity(intent.setClass(this, if (tv) com.github.birros.vlc.gui.tv.SearchActivity::class.java else SearchActivity::class.java))
            finish()
            return
