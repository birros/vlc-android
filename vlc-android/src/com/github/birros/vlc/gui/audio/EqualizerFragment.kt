 ...
 *****************************************************************************/
package com.github.birros.vlc.gui.audio
...
import com.github.birros.vlc.PlaybackService
import com.github.birros.vlc.R
import com.github.birros.vlc.VLCApplication
import com.github.birros.vlc.databinding.EqualizerBinding
import com.github.birros.vlc.gui.dialogs.VLCBottomSheetDialogFragment
import com.github.birros.vlc.gui.helpers.UiTools
import com.github.birros.vlc.gui.view.EqualizerBar
import com.github.birros.vlc.interfaces.OnEqualizerBarChangeListener
import com.github.birros.vlc.util.Settings
import com.github.birros.vlc.util.VLCInstance
import com.github.birros.vlc.util.VLCOptions
...
class EqualizerFragment : VLCBottomSheetDialogFragment(), CoroutineScope by MainScope() {
    ...
    private val newPresetName = VLCApplication.appResources.getString(com.github.birros.vlc.R.string.equalizer_new_preset_name)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = DataBindingUtil.inflate(inflater, com.github.birros.vlc.R.layout.equalizer, container, false)
        binding.state = state
        return binding.root
    }
    ...
    private fun fillViews() = launch(start = CoroutineStart.UNDISPATCHED) {
        ...
        eqBandsViews[0].nextFocusLeftId = com.github.birros.vlc.R.id.equalizer_preamp
        eqBandsViews[eqBandsViews.size - 1].nextFocusRightId = com.github.birros.vlc.R.id.snapBands
    ...
    private fun createSaveCustomSetDialog(positionToSave: Int, displayedByUser: Boolean, onPause: Boolean) {
        ...
        val klNormal = resources.getDimension(com.github.birros.vlc.R.dimen.kl_normal).toInt()
    ...
    private fun createDeleteCustomSetSnacker() {
        ...
        if (getEqualizerType(oldPos) == TYPE_CUSTOM) {
            ...
            val message = getString(com.github.birros.vlc.R.string.custom_set_deleted_message, oldName)
    ...
    private fun revertCustomSetChanges() {
        ...
        val message = if (getEqualizerType(pos) == TYPE_CUSTOM)
            getString(com.github.birros.vlc.R.string.custom_set_restored)
        else
            getString(com.github.birros.vlc.R.string.unsaved_set_deleted_message)
        UiTools.snackerWithCancel(binding.root, message, null, cancelAction)
    }
