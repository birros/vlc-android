...
import com.github.birros.vlc.RecommendationsService
import com.github.birros.vlc.gui.tv.TvUtil.diffCallback
...
import com.github.birros.vlc.viewmodels.tv.MainTvModel
import com.github.birros.vlc.viewmodels.tv.MainTvModel.Companion.getMainTvModel
        ...
        when (row?.id) {
            ...
            HEADER_MISC -> {
                when ((item as GenericCardItem).id) {
                    ID_SETTINGS -> activity.startActivityForResult(Intent(activity, com.github.birros.vlc.gui.tv.preferences.PreferencesActivity::class.java), ACTIVITY_RESULT_PREFERENCES)
                    ID_REFRESH -> {
